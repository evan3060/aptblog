...
description: >-
  Four-layer architecture (access/bus/core/infrastructure) + shared design
  motivation, why strict unidirectional dependencies matter, comparison of three
  agent architecture approaches, and the 'Your...
tags:
  - architecture
  - layered-design
  - aptbot
...
![Four-Layer Architecture Diagram](/images/02-aptbot-architecture/aptbot-layers.png)
...
![Unidirectional Dependency Diagram](/images/02-aptbot-architecture/aptbot-dependency.png)
