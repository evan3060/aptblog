...
description: >-
  Understanding the AgentTool interface, declarative registry, 4 built-in tools,
  TypeBox parameter validation, multi-layered security, and comparison of three
...
![Tool System Architecture](/images/04-tool-system/tool-architecture.png)
