...
description: >-
  Starting from the problem of multi-client access, comparing the design
  trade-offs of three access approaches, to a deep dive into aptbot's typed
  event bus, minimal Channel interface, bindSession...
tags:
  - channel
  - transport
  - websocket
...
![Channel Multi-Client Access Architecture](/images/08-channel-transport/channel-architecture.png)
