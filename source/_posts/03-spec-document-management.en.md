---
title: >-
  Spec Document Management: Project Memory and Decision Constitution for
  AI-Assisted Development
description: >-
  Boundaries between spec, plan, and design; file organization conventions; full
  lifecycle management (draft → review → active → revision → archive);
  self-review checklist; code synchronization...
tags:
  - spec
  - documentation
  - lifecycle
...
![Spec Document Lifecycle](/images/03-spec-document-management/spec-lifecycle.png)
