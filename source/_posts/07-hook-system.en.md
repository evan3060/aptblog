...
description: >-
  From the design motivation of the hook pattern, comparing three agent
  extension approaches, to a deep dive into aptbot's 8 hook point topology,
  synchronous chain execution model, two-layer plugin...
tags:
  - hook
  - plugin
  - extensibility
...
![Hook 8 Point Topology](/images/07-hook-system/hook-system.png)
