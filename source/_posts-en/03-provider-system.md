...
description: >-
  Design motivation for separating API from Provider, three API protocols,
  dual-clock streaming control, error classification with retry and backoff,
  MixinProvider failover and spring-back mechanism,...
tags:
  - provider
  - streaming
  - retry
...
![Provider Failover Flow](/images/03-provider-system/provider-failover.png)
