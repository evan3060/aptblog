...
description: >-
  Understanding the core tension of agent memory systems, JSONL append-only
  persistence design, incremental streaming parsing with corruption tolerance,
  Compaction strategy, cross-session memory...
tags:
  - memory
  - jsonl
  - compaction
...
![Memory System Architecture](/images/05-memory-system/memory-architecture.png)
