...
description: >-
  External layered retry philosophy, three-layer retry
  (transport/business/semantic), errors not persisted, AgentEvent union type,
  EventStream → UI reducer pattern, streaming rendering/turn...
tags:
  - error-handling
  - streaming
  - event-stream
...
![Error Handling and Streaming Event Flow](/images/11-error-streaming-ux/error-streaming.png)
