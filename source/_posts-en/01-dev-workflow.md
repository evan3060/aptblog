...
description: >-
  Four-stage workflow, document layering, dual review, circuit breaker
  mechanism, kanban management and TDD red-green cycle — how to make AI output
  from unpredictable to controllable and traceable
tags:
  - workflow
  - tdd
  - constraints
...
![AI-Assisted Development Workflow](/images/01-dev-workflow/dev-workflow.png)
