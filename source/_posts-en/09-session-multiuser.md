...
description: >-
  Starting from the fundamental problems of session management, comparing the
  design trade-offs of three persistence approaches, to a deep dive into
  aptbot's JSONL + sidecar storage, access control,...
tags:
  - session
  - multi-user
  - persistence
...
![Session System Architecture](/images/09-session-multiuser/session-system.png)
