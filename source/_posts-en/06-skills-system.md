...
description: >-
  Understanding the 'knowledge layer' positioning of skills in an agent, how the
  two-layer loading mechanism balances built-in and custom skills, the minimal
  frontmatter design philosophy, L1 index...
tags:
  - skills
  - system-prompt
  - hot-reload
...
![Skills System Architecture](/images/06-skills-system/skills-system.png)
